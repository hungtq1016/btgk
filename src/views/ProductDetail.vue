                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner border">
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="http://127.0.0.1:5173/src/assets/img/product-1.jpg"
                                alt="Image">
                        </div>
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="http://127.0.0.1:5173/src/assets/img/product-2.jpg"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="http://127.0.0.1:5173/src/assets/img/product-3.jpg"
                                alt="Image">
                        </div>
                        <div class="carousel-item">
                            <img class="w-100 h-100" src="http://127.0.0.1:5173/src/assets/img/product-4.jpg"
                                alt="Image">
                        </div>
                    </div>
                        ...
                        <div class="input-group-btn">
                            <button class="btn btn-primary btn-minus">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                    stroke-width="1.5" stroke="currentColor" width="10px" height="18px">
